...
def get_help_content(burl):
    ...
    s04descr = 'In just a quick glance, "Control Center" gives you what actions you have to take today such as which trades you might have to close or open. Note that the color code of the tag relate to the tradebook tag for you to recognize actions to take.'
    s05 = imgsrc + '05.png'
