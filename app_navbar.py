...
def get_top_signals_menu(burl):
    ...
    try:
        ...
        r = '<li class="nav-item"><a class="nav-link" href="'+ link +'">'+ l_top_signal +'&nbsp;<span class="badge badge-pill badge-info">'+ str(i) +'</span></a></li>'
        cr.close()
        connection.close()
...
def get_top_trader_menu(burl):
    ...
    try:
        ...
        r = '<li class="nav-item"><a class="nav-link" href="'+ link +'">'+ l_top_trader +'&nbsp;<span class="badge badge-pill badge-info">'+ str(i) +'</span></a></li>'
        cr.close()
        connection.close()
    except Exception as e: print(e)
    return r
