...
def get_portfolio_button(burl):
    ...
    try:
        ...
        portfolio_button = '<a href="'+burl+'p/?ins=1&step=1&button=None" class="btn btn-lg btn-primary" style="font-size:x-large;" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="'+ l_create_portfolio +'"><i class="fas fa-edit"></i></a>'
        r = portfolio_button
    except Exception as e: print(e)
    return r
