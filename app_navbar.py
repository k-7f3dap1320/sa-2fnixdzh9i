...
def navbar(burl):
    ...
    if user_is_login() == 1:
        ...
        rightsidemenu = get_how_menu(burl) + '<li class="nav-item"><a href="'+burl+'pricing" class="btn btn-sm btn-danger btn-block form-signin-btn"><i class="fas fa-sign-in-alt"></i>&nbsp;'+ l_join_now_btn +'</a></li>'
