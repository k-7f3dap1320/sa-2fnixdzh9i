...
def get_newsfeed(x,suid,numline,show_chart):
    ...
    try:
        ...
        for row in rs:
            ...
            '    <div class="'+ bsclass +' col-sm-12 col-xs-12" style="border-top:solid; border-left:none; border-right:none; border-bottom:none; border-width: 0.5px; border-style: dotted;"> '+\
            '       <strong>'+ str(i) +')'+'</strong>'+\
