...
def get_sign_ta_chart_alt_orders(uid):
    ...
    try:
        ...
        '                      <div id="'+ tab_2_id +'" class="tab-pane fade"><br /><div style="height: 500px; width:99%">'+ get_tradingview_indicators(uid,'100%','100%') + '</div></div>'+\
        '                      <div id="'+ tab_3_id +'" class="tab-pane fade"><br /><div style="height: 500px; width: 99%">'+ get_tradingview_chart(uid) +'</div></div>'+\
        '                      <div id="'+ tab_4_id +'" class="tab-pane fade"><br /><div style="height: 500px; width: 99%">'+ get_tradingview_fundamental_widget(uid) + '</div></div>'+\
        '                      <div id="'+ tab_5_id +'" class="tab-pane fade"><br /><div style="height: 500px; width: 99%">'+ get_tradingview_profile_widget(uid) + '</div></div>'+\
        '                  </div>'+\
        '            </div>'+\
        '        </div>'
