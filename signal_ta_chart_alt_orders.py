...
def get_sign_ta_chart_alt_orders(uid):
    ...
    try:
        ...
        '                      <div id="'+ tab_2_id +'" class="tab-pane fade"><br /><div style="height: 85%; width:95%">'+ get_tradingview_indicators(uid) + '</div></div>'+\
        '                      <div id="'+ tab_3_id +'" class="tab-pane fade"><br /><div style="height: 85%; width: 95%">'+ get_tradingview_chart(uid) +'</div></div>'+\
