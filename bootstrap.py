...
def get_bootstrap(theme,burl):
    ...
    if theme == 'light':
        ...
        selected_bootcss_integrity = bootcss_integrity
    else:
        selected_bootcss = bootcss_dark_url
        selected_bootcss_integrity = ''
    ...
    bootcss = '<link rel="stylesheet" href="'+ selected_bootcss +'" integrity="'+ selected_bootcss_integrity +'" crossorigin="anonymous">'
