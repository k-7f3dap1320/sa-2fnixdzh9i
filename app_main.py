...
from user_aggregate_perf import *
...
def gen_main_page(x,appname,burl,is_dashboard):
    ...
    if is_dashboard == str(1):
        ...
        dashboard_content = dashboard_content + '<div class="row">' + get_trades_box(0,burl,is_dashboard) + get_control_center(burl) + get_aggregate_perf() + '</div>'
