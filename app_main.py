...
def gen_main_page(x,appname,burl):
    ...
    r = get_head( get_loading_head() + get_title( appname +' - Market intelligence') + get_metatags() + get_bootstrap() + get_awesomplete() + get_google_chart_script() + get_stylesheet(burl) )
