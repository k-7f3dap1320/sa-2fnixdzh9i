...
def gen_main_page(x,appname,burl,is_dashboard):
    ...
    if is_dashboard == str(1):
        dashboard_content = '<div class="row">' + get_trades_box(0,burl,is_dashboard) + '</div>'
        dashboard_content = dashboard_content + '<div class="row">' + get_box_list_instr_n_portf(burl,'dashboard','portf',0,0,500,None) + '</div>'
