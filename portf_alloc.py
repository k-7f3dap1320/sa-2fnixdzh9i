    ...
    try:
        ...
        for row in rs:
            ...
            if order_type == 'buy':
                ...
                if i == 0:
                    pie_chart_option = '{'+ str(i) +':{color:"rgb('+ buy_color_R +','+ buy_color_G +','+ buy_color_B +')"}}'
                else:
                    pie_chart_option = pie_chart_option + ', {'+ str(i) +':{color:"rgb('+ buy_color_R +','+ buy_color_G +','+ buy_color_B +')"}}'
            if order_type == 'sell':
                if buy_color_B > num_rec:
                    buy_color_R = buy_color_R - num_rec
                ...
                if buy_color_B < (255 - num_rec):
                    buy_color_B = buy_color_B + num_rec
                if i == 0:
                    pie_chart_option = '{'+ str(i) +':{color:"rgb('+ sell_color_R +','+ sell_color_G +','+ sell_color_B +')"}}'
                else:
                    pie_chart_option = pie_chart_option + ', {'+ str(i) +':{color:"rgb('+ sell_color_R +','+ sell_color_G +','+ sell_color_B +')"}}'
