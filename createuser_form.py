...
def get_user_creation_form(burl):
    ...
    try:
        ...
        '                        <input type="text" name="name" class="form-control btn-info" id="name" placeholder="Your name" required autofocus>'+\
        '                    </div>'+\
        '                </div>'+\
        '            </div>'+\
        '        </div>'+\
        ...
        '                        <input type="email" name="email" class="form-control btn-info" id="email" placeholder="Your email: you@example.com" required autofocus>'+\
        '                    </div>'+\
        '                </div>'+\
        '            </div>'+\
        '        </div>'+\
        ...
        '                        <input type="password" name="password" class="form-control btn-info" id="password" placeholder="Password" required>'+\
        '                    </div>'+\
        '                </div>'+\
        '            </div>'+\
        '        </div>'+\
