...
def get_stylesheet(burl):
    ...
    signpart = '.sign-part{background:black; border-radius:0; margin:10px 0px;}'
    signrow = '.sign-row{background-color: black;}'
    ...
    sa_box_h = '.sa-box-h{height: 200px;}'
    sa_signin_box = '.sa-signin-box{background-image:url('+ burl + 'static/sibg.gif?'+ get_random_str(9)  + '); background-size:100% 100%; height: 300px; color: white; text-align: justify; padding: 20px; }'
