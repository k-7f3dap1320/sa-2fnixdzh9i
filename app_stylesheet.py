...
def get_stylesheet(burl):
    ...
    sa_chart_hw_100 = '.sa-chart-hw-100{height: 330px;}'
    ...
    sa_signal_ta_chart = '.sa-signal-ta-chart{height: 600px; overflow: auto;}'
    sa_signal_alt_ord_prf = '.sa-signal-alt-ord-prf{height: 340px; overflow: auto; font-size: 12px;}'
