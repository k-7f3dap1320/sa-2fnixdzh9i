    ...
    try:
        ...
        if user_is_login() == 1:
            ...
            if i < 5:
                ...
                sql = "SELECT symbol_list.uid FROM instruments JOIN symbol_list ON symbol_list.symbol = instruments.symbol "+\
                "WHERE instruments.symbol NOT LIKE '%"+ get_portf_suffix() +"%' AND (instruments.y1_signal > 0 AND instruments.m6_signal > 0 AND instruments.m3_signal > 0 AND instruments.m1_signal > 0) AND "+\
