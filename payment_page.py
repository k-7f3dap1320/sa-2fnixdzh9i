...
def get_box_plan_selection(burl):
    ...
    try:
        ...
        l_feature_01 = '<strong>Create and track your financial portfolio’s performance.</strong>'
        ...
        l_feature_05 = 'Get a “straight to the point” snapshot of what’s happening in the global financial market.'
        ...
        '      <th scope="col" style="vertical-align: top; text-align: left;"><h3>'+ l_price +'<sup>/month</sup></h3><div style="font-size:small;" class="text-danger">'+ l_less_than_price_coffee_day +'</div></th>'+\
        '    </tr>'+\
        '  </thead>'+\
        '  <tbody>'+\
        '    <tr>'+\
