...
def save_settings(name,nickname,username,default_profile,email_subscription):
    ...
    if checknickname.lower() == nickname.lower():
        return_data = return_data + ' '+ l_error_message_nickname_exists.replace('{nickname}',nickname)
...
def get_radio_button_Trader_prf(default_profile):
    ...
    for row in rs:
        ...
        return_data = return_data + '<input type="radio" name="'+ l_radioBtn_name +'" value="'+ str(value) +'" '+ checkedRadio +'>&nbsp;'+ str(label) +'&nbsp;'+ l_market +'<br>'
    ...
    for row in rs:
        ...
        checkedRadio =''
        if value.lower() == default_profile.lower(): checkedRadio = 'checked'
        return_data = return_data + '<input type="radio" name="'+ l_radioBtn_name +'" value="'+ str(value) +'" '+ checkedRadio +'>&nbsp;'+ str(label)+'<br>'
    cr.close()
    connection.close()
    return return_data
