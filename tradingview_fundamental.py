...
def get_redirect_to_tradingview_fd(uid,burl):
    ...
    r = '<body onmouseover="document.location.href=\''+ get_tradingview_fundamental(uid) +'\'"><div style="width: 100%; height:100%; position:fixed; color:rgba(242, 241, 246, 1);"><div style="width:88%; height:88; position:absolute; left:50%; top:50%; transform: translate(-50%, -50%);">'+ l +'</div></div></body>'
    return r
