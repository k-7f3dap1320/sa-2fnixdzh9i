...
def get_market_list(burl,mode):
    ...
    for row in rs:
        ...
        if not label == 'x': return_data = return_data + ' <a href="'+ burl +'n/?step=d&x='+ asset_class_id +'" class="list-group-item list-group-item-action">'+ label +'</a>'
    ...
    for row in rs:
        ...
        if not label == 'x': return_data = return_data + ' <a href="'+ burl +'n/?step=d&x='+ market_id +'" class="list-group-item list-group-item-action">'+ label +'</a>'
