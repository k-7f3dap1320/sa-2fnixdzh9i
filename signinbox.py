...
def get_signin_box(burl):
    ...
    if user_is_login() == 0:
        ...
        etoro_logo_form = broker_link_form = go_to_url(get_broker_affiliate_link('eToro', 'affiliate'),'form','eToro')
        etoro_logo_link = broker_link_form = go_to_url(get_broker_affiliate_link('eToro', 'affiliate'),'link','eToro')
