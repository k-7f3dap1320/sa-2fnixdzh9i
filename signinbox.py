...
def get_signin_box(burl):
    ...
    try:
        ...
        if user_is_login() == 0:
            ...
            '                       <img src="'+ burl +'static/etoro-logo.png" height="40px" style="margin:20px;" />'+\
            '                       <img src="'+ burl +'static/tradingview-logo.png" height="40px" style="margin:20px;" />'+\
            '                       <img src="'+ burl +'static/morningstar-logo.png" height="40px" style="margin:20px;" />'+\
            '                       <img src="'+ burl +'static/aws-logo.png" height="40px" style="margin:20px;" />'+\
            '                   </div>'+\
            '                </div>'+\
